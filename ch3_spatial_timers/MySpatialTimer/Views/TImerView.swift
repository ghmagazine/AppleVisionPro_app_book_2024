    ...
    var body: some View {
        VStack {
            ...
            HStack(spacing: 24) {
                ...
                Button {
                    timerModel.isNotificationOn.toggle()
                } label: {
                    Image(systemName: timerModel.isNotificationOn ? "bell" : "bell.slash")
                }
                ...
                Button {
                    immersiveViewModel.removePlaceHolder(timerModelID: timerModel.id)
                } label: {
